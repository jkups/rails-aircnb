...
class PropertiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create property" do
    assert_difference('Property.count') do
      post properties_url, params: { property: { address: @property.address, bathrooms: @property.bathrooms, bedrooms: @property.bedrooms, cleaning_fee: @property.cleaning_fee, description: @property.description, heading: @property.heading, latitude: @property.latitude, longitude: @property.longitude, max_guests: @property.max_guests, service_fee: @property.service_fee, title: @property.title } }
    end
